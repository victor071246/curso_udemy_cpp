...
public:
	//Construtor com parâmetros. Desta forma podemos criar objetos e já enviar argumentos para serem inicializados nos atributos(variáveis) do objeto
	...
	//Contudo como criamos abaixo um construtor o compilador deixou de criar o construtor e por isso não podemos mais criar objetos sem ser através deste construtor abaixo:
	//E aí precisaria enviar argumentos iniciais
	...
	//Neste caso o parâmetro Destino recebe apenas uma cópia do valor do objeto. Ele não tem como alterar o objeto
