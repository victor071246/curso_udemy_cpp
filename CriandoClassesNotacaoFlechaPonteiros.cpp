...
int main()
{
	...
	//Agora você está criando, instanciando um objeto via alocação dinâmica de memória, utilizando ponteiros*. Basicamente é o mesmo que declarar da da forma que você declarou na aula passada. Ou seja, será criado um objeto baseado na classe Casa e o endereço de memória deste objeto será colocado em CasaDePraia.
	...
	//*ptr mas neste caso o ponteiro é casa de praia
	...
	//(EndereçoQueFunçãoAponta).funcao();
	(*CasaDePraia).MostrarTamanho();
