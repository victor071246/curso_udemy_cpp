...
int main()
{
	...
	Num2 ++ Pegue logo o valor da variável Num2 e somente depois da instrução incremente em 1 o valor de Num2
	Logo Num1 = Num2++ é equivalente as seguintes instruções:
	Num1 = Num2;
	Num2 = Num2;
	Chamamos isso de pós-fixado
	Assim se o ++ ou -- estiver após a variável ela somente será incrementada após a instrução*/
